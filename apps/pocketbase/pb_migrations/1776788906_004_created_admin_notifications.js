...
migrate((app) => {
  const collection = new Collection({
    ...
    "fields":     [
          ...
          },
          {
                "hidden": false,
                "id": "text0708938814",
                "name": "recipient_subscription_status",
                "presentable": false,
                "primaryKey": false,
                "required": false,
                "system": false,
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_5287317308");
